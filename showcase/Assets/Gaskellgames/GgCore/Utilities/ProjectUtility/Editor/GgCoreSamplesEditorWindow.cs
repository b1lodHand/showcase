...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GgCoreSamplesEditorWindow : GGEditorWindow_MenuTree
    {
        ...
        private string assetPath = "Assets/Gaskellgames/GgCore/Utilities/ProjectUtility/Editor/Icons/";
        ...
        {
            banner = (Texture)AssetDatabase.LoadAssetAtPath(assetPath + "InspectorBanner_GgCore.png", typeof(Texture));
